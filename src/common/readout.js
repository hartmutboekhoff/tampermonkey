...
*/
  ...
  function mergeUtteranceOptions(a, b, c) {
    return {
      ...
      reduceUtterances: a?.reduceUtterances ?? b?.reduceUtterances ?? c?.reduceUtterances,
    };
  } 
...
*/
  ...
  class UtteranceCollector {
    ...
    get utterances() {
      ...
      return this.options.reduceUtterances? this.#reduceUtterances(utterances) : utterances;
    }
    get format() {
      return Format;
    }
...
*/
  class ReadOutQueue {
    ...
    #speak(uix) {
      ...
      console.debug('Speaking:', u.lang, u.text, u.htmlElements);
